...
for method in method_set:
    ...
    for epsilon in epsilon_set:
        ...
        if method == 'BayesWRM' or method == 'Bayes':
            if blackbox == False:
                ...
                adversary = FGSMAttack(subnet, epsilon, is_train=False)
            ...
            if blackbox == False:
                ...
                adversary = FGSMAttack(subnet, epsilon, is_train=False, advtraining=method)
    ...
    if blackbox == False:
        df.to_csv(os.path.join('fashionmnistwhitebox', method+'_whitebox_'+str(args.sample)+'.csv'))
    else:
        df.to_csv(os.path.join('fashionmnistblackbox', method+'_blackbox.csv'))
