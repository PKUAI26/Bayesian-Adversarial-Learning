...
class FashionMNIST(data.Dataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, download=False, fixedindex=0):
        ...
        if self.fixedindex != 0:
            print('warining: using only the fixed index '+str(self.fixedindex))
